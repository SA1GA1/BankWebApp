...
USERS = [
    (77001, "Иван Иванов", "40817810000000000001", "+79001234501", 245_300.50),
...
def seed_if_empty() -> None:
    with get_conn() as conn:
        ...
        thread1 = [
            (77002, 77001, "Привет! Не забудь про встречу завтра в 12 :)", 6),
            (77001, 77002, "Помню, до завтра!", 6),
            (77002, 77001, "Захвати, пожалуйста, кофе по дороге.", 5),
            (77001, 77002, "Окей, какой?", 5),
            (77002, 77001, "Капучино без сахара", 5),
        ]
